...
int main()
{
    ...
    cout << "Name - Tanay Dubey" << endl;
    cout << "Registration number - 19BCT0185" << endl;
    cout << "Digital Assignment 1" << endl;
    ...
    {
        int pit_loc = 1;
        while (pit_loc == 1 || pit_loc == gold || pit_loc == wumpus || prepositional[pit_loc / 4][pit_loc % 4 - 1][2] == 1)
        {
            srand(time(0));
            pit_loc = (rand() % 16) + 1;
        }
    ...
    while (health > 0 && score != 1000)
    {
        ...
        if (prepositional[row][col][1] == 1)
        {
            ...
            {
                cout << "Agents hits the wumpus and killed it and hears a loud scream of wumpus" << endl;
